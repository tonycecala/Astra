export const ui = {
  ...
  self: {
    ...
    reportReaderTitle: "Generated report",
    ...
    reportLibraryReady: "The generated report is available in Library and can still publish a Journey signal from its report card.",
