export const ui = {
  ...
  self: {
    ...
    reportReaderEmpty: "Generate a report to read its private sections here. Completed reports are saved to Library automatically.",
    reportCloseCta: "Close report",
    reportSavedToLibrary: "Generated reports are saved to Library automatically.",
    reportLibraryTitle: "Library handoff",
    reportLibraryReady: "The generated report is available in Library and can still publish a Journey signal from the slide-up reader.",
    reportLibraryCta: "Open Library",
