...
export function buildDeepSectionPrompt(
  ...
  dependencies: {
    ...
    evidenceToProseContract: (request: AstrologyReportRequest) => readonly string[];
  ...
  return [
    ...
    dependencies.deepChapterFocusInstruction(request, card.title), ...dependencies.plainspokenContract, dependencies.plainspokenParagraphRule(request, "chapter"), ...dependencies.evidenceToProseContract(request), ...dependencies.interpretiveContractFor([card]), ...dependencies.psychologicalSafetyContract,
...
export function buildDebugModelPrompt(
  ...
  dependencies: {
    ...
    evidenceToProseContract: (request: AstrologyReportRequest) => readonly string[];
    progressedEvidenceToProseContract: (request: AstrologyReportRequest) => readonly string[];
    interpretiveContractFor: (cards: readonly SectionPromptCard[]) => readonly string[];
    psychologicalSafetyContract: readonly string[];
  ...
  return [
    ...
    ...dependencies.evidenceToProseContract(request),
    ...dependencies.progressedEvidenceToProseContract(request),
