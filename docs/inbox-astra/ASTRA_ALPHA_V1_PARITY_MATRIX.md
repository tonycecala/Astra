...
| Report validation | `lib/report-v2/allowed-claims.ts`, `lib/report-v2/evidence-completeness.ts`, `lib/report-v2/validate-report-v2-markdown.ts` | V2 has raw evidence ban, required headings, forbidden fragments, and unsupported sign/aspect claim checks. | Continue tightening from v1 allowed-claims/evidence-completeness only. |
