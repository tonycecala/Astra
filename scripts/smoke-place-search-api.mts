...
import { birthPlaceSearchResponseSchema } from "@astra/contracts";
...
const email = clean(process.env.ASTRA_PLACE_SEARCH_SMOKE_EMAIL) || `place-search-smoke-${Date.now()}@example.com`;
const name = clean(process.env.ASTRA_PLACE_SEARCH_SMOKE_NAME) || "Astra Place Search Smoke";
