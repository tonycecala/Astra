...
Synastry prose should lead with psychology, not astrology exposition. Occasional brief astrology references are acceptable when they clarify the mechanism without taking over the paragraph. Treat them as review notes when density stays at or below 8 terms per 1,000 words and no paragraph contains three or more technical terms; keep visible Evidence IDs, astrology-heavy paragraphs, and higher-density exposition as fatal technical-surface leakage.
