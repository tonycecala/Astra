...
For clean-prose report experiments, assign stable evidence IDs to the direct signal packet and keep the ID-to-signal index plus chapter trace private. Verify two separate properties: trace completeness and semantic fidelity. An output can cite every valid ID while still adding fate, burden, or comparative-contribution claims that the evidence does not license. Second-person address is also not proof of dual perspective: measure or review the other person's independent interiority and the relationship's third-protagonist role separately. Zero technical leakage, exact tone framing, word range, anti-biography rules, anti-fate rules, and anti-contribution-ledger rules should be deterministic acceptance gates before editorial preference is considered.
