...
- `apps/composer-web/app/api/chart-arrival/rewrite/route.ts` - 1 route handler(s), 1 export(s), 15 symbol(s), 3 import(s), ~499 tokens
...
- `packages/db/src/repositories.ts` - weight 1107.17, ~20793 tokens, 235 symbols, in:1/out:2
...
- `packages/contracts/src/index.ts` - weight 604.22, ~12107 tokens, 220 symbols, in:0/out:0
- `apps/astra-web/components/BirthOnboardingPanel.tsx` - weight 592.2, ~14995 tokens, 133 symbols, in:2/out:6
...
- `apps/astra-web/e2e/foundation-routes.spec.ts` - weight 344.22, ~12131 tokens, 98 symbols, in:0/out:2
...
- `docs/progress/PROGRESS_LOG.md` - weight 277.19, ~16548 tokens, 91 symbols, in:0/out:0
...
- `PATCH /api/profile/focus` in `apps/astra-web/app/api/profile/focus/route.ts:6`
...
- `64000` tokens -> 2 files, 907 symbols, ~66929 estimated tokens.
- `128000` tokens -> 7 files, 1834 symbols, ~130186 estimated tokens.
...
Generated from 462 local files for `astra-clean-start`.
