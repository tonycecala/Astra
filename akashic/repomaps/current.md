...
- Estimated token footprint: `1181663`
...
## Critical Files
- `packages/astrology/src/index.ts` - weight 2851.11, ~45876 tokens, 667 symbols, in:0/out:16
...
## Pareto Profiles
- `32000` tokens -> 1 files, 667 symbols, ~45876 estimated tokens.
- `64000` tokens -> 2 files, 892 symbols, ~65771 estimated tokens.
- `128000` tokens -> 8 files, 1899 symbols, ~138127 estimated tokens.
...
Generated from 451 local files for `astra-clean-start`.
