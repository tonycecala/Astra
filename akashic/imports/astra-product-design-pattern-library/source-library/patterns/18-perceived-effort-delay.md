---
title: "Perceived Effort Delay"
slug: "18-perceived-effort-delay"
priority: "medium"
astra_area: "premium reports"
source: "The Product Design Playbook, flattened text upload"
status: "codex-ready"
---

# Astra Pattern Skill: Perceived Effort Delay

## Core Principle
Use brief intentional pauses when instant output would feel cheap.
...
## Avoid
- Delaying ordinary navigation
- Repeated artificial waits
- No explanatory copy
...
- `trust_score_by_delay`
- `premium_conversion_rate`
- `generation_satisfaction`

## Codex Implementation Direction
Insight can benefit from a considered pause. Navigation cannot.
