...
slug: "17-loading-feedback"
priority: "high"
astra_area: "ai generation, reports"
source: "The Product Design Playbook, flattened text upload"
status: "codex-ready"
---

# Astra Pattern Skill: Loading Feedback

## Core Principle
Turn waits into branded, meaningful process states.
...
- `generation_abandon_rate`
- `perceived_speed_score`
- `retry_rate`

## Codex Implementation Direction
Whenever Astra must wait, explain the ritual: what is being prepared, why it matters, and what comes next.
