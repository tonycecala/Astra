...
slug: "28-variable-reward"
priority: "dangerous"
astra_area: "stream, discovery"
source: "The Product Design Playbook, flattened text upload"
status: "codex-ready"
---

# Astra Pattern Skill: Variable Reward

## Core Principle
Use light novelty at the edges, never chance-driven compulsion.
...
## Use In Astra
- Daily surprise insight
- Rare beautiful card variant
- Rotating reflective prompt

## Avoid
- Slot-machine mechanics
- Random payoffs gating value
...
Surprise should serve wonder. It must never become manipulation.
