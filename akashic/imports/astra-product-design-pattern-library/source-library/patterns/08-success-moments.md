...
slug: "08-success-moments"
priority: "critical"
astra_area: "ritual, retention"
source: "The Product Design Playbook, flattened text upload"
status: "codex-ready"
---

# Astra Pattern Skill: Success Moments

## Core Principle
Mark meaningful progress with brief, earned ceremony.
...
- `success_next_action_rate`
- `share_after_success_rate`
- `return_after_milestone`

## Codex Implementation Direction
Design Astra celebrations as small rituals: dignity, beauty, meaning, no casino noise.
