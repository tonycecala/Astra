...
slug: "19-intentional-friction"
priority: "high"
astra_area: "trust, purchase, destructive actions"
source: "The Product Design Playbook, flattened text upload"
status: "codex-ready"
---

# Astra Pattern Skill: Intentional Friction

## Core Principle
Slow users down only when clarity, consent, or protection demands it.
...
## Avoid
- Extra steps for vanity metrics
- Confusing paywall friction
...
Friction should protect the user or deepen commitment. Otherwise remove it.
