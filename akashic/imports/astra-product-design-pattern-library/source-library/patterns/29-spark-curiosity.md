...
slug: "29-spark-curiosity"
priority: "adapt-carefully"
astra_area: "reports, onboarding"
source: "The Product Design Playbook, flattened text upload"
status: "codex-ready"
---

# Astra Pattern Skill: Spark Curiosity

## Core Principle
Reveal enough to invite exploration while preserving payoff.
...
## Use In Astra
- Blurred sample section
- 'There are 3 major themes in your chart'
- Preview card before full report

## Avoid
- Artificial walls
- Teasing without payoff
- Fear-based mystery
...
- `preview_to_open_rate`
- `paywall_conversion`
- `frustration_feedback`

## Codex Implementation Direction
Curiosity works when the hidden thing is real, relevant, and quickly resolvable.
