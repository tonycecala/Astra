...
slug: "16-micro-interactions"
priority: "medium"
astra_area: "experience refinement"
source: "The Product Design Playbook, flattened text upload"
status: "codex-ready"
---

# Astra Pattern Skill: Micro Interactions

## Core Principle
Use subtle feedback to make Astra feel alive and responsive.
...
## Use In Astra
- Card save pulse
- Constellation star snap
- Report generation shimmer
- Haptic on meaningful success

## Avoid
- Over-animation
- Motion that slows flow
- Uncontrolled haptics
...
- `motion_setting_optout`

## Codex Implementation Direction
Micro-interactions should confirm action, not decorate latency.
