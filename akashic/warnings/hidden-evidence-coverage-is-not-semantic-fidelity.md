---
title: "Hidden evidence coverage is not semantic fidelity"
type: "warning"
...
related: []
---
# Hidden evidence coverage is not semantic fidelity

## What Happened
In clean-prose relationship-report experiments, a private evidence trace can cite every valid signal while the rendered portrait still invents fate, ancient-history, burden, or unequal-contribution claims. Validate trace completeness and semantic fidelity separately; second-person address also needs an independent check that the other person's interiority remains distinct.
